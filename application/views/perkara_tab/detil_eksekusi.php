<div class="detil" style="font-size:14px;margin-top:15px;width: 99%;margin: 0 auto;border-color: #FFFFFF;">
	...
	<table id="tableDetilPerkara" style="font-size:14px;" width="99%">
		...
		<tbody>
			...
			<tr class="kasasi_hide">
			    <td bgcolor='#5FB85C'><font color='white'>Nomor Perkara Kassi</font></td>
    ...
    <table id='infoPerkara' width="100%" class="cssTable" style="margin:0px;padding:0px; ">
    	...
    	<tbody>
    		...
    		<tr>
    			<td style="padding:0px;padding-left:5px;"><?php echo $permohonanEsekusi;?></td>
    			<td style="padding:0px;padding-left:5px;"><?php echo $pemohonEksekusi;?></td>
    			<td style="padding:0px;padding-left:5px;"><?php echo $paraPihak;?></td>
        ...
        if($queryEksekusiDetil!=''){
			if($queryEksekusiDetil->num_rows>0){
				foreach ($queryEksekusiDetil->result() as $row) {
    				echo "<tr>";
    				echo "<td align=\"center\" style=\"padding:0px;padding-left:5px;\">".$no."</td>";
    				echo "<td style=\"padding:0px;padding-left:5px;\">".$row->nama."</td>";
    				echo "<td style=\"padding:0px;padding-left:5px;\">".$row->statusPihak."</td>";
    				$no++;
    				echo "</tr>";
				}
			}
    ...
    <?php } else { ?>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Tanggal Penetapan Teguran Eksekusi</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $penetapanTeguranEksekusi;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Nomor Penetapan Teguran Eksekusi</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $nomorPenetapanTeguranEksekusi;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Tanggal Pelaksanaan Teguran Eksekusi</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $pelaksanaanTeguranEksekusi;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Tanggal Penetapan Sita Eksekusi</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $penetapanSitaEksekusi;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Nomor Penetapan Sita Eksekusi</font></td>
        ...
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Tanggal Penetapan Perintah Eksekusi Riil</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $penetapanPerintahEksekusiRill;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Tanggal Pelaksanaan Eksekusi Riil</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $pelaksanaanEksekusiRill;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Tanggal Penetapan Non-Eksekusi</font></td>
            <td style="padding:0px;padding-left:5px;"><?php echo $penetapanNoneksekusi;?></td>
        </tr>
        <tr>
            <td bgcolor='#5FB85C'><font color='white'>Alasan Eksekusi</font></td>
