	...
	<div id="usual2" class="usual"> 
		<ul>
			...
			if ($idProses>=20 AND $ada_penetapan>0){
					...
					echo "<li class='tab'><a href=\"#tabs2\" id= 'tabInfo'>Penetapan<?php echo $ada_data_saksi; ?></a></li>";
			...
			if ($idalurperkara==118 && $idProses>=65 && $ada_data_diversi>0){
		...
		if ($idalurperkara==19) {
          if ($wekppu->num_rows()>0){
			...
			if($idalurperkara>=111 && $idalurperkara!=119 && $idalurperkara!=114){
